...
\begin{enumerate}
    \item To develop a flexible single-index multinomial model for analyzing road traffic accident data.
    \item To evaluate the performance of the proposed model using simulations and real-world accident data.
    \item To identify and quantify the impact of various predictors, such as weather conditions, road types, and traffic controls, on accident rates.
\end{enumerate}
